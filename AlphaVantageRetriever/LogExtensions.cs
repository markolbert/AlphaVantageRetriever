...
internal static partial class LogExtensions
{
    ...
    public static partial void MultipleRetrievers(this ILogger logger, string retriever, [CallerMemberName] string caller = "");

    [LoggerMessage(LogLevel.Warning, "{caller}: retrieval function {function} specified for multiple retrievers, first will be used")]
    public static partial void OverlappingFunctions(this ILogger logger, string function, [CallerMemberName] string caller = "");

    [LoggerMessage(LogLevel.Error, "{caller}: no parser defined for {retriever}")]
    public static partial void NoParser(this ILogger logger, string retriever, [CallerMemberName] string caller = "");

    [LoggerMessage(LogLevel.Warning, "{caller}: multiple parser defined for {retriever}, first will be used")]
    public static partial void MultipleParsers(this ILogger logger, string retriever, [CallerMemberName] string caller = "");
    ...
    public static partial void NoParserDefined(this ILogger logger, string dataSet, [CallerMemberName] string caller = "");
    ...
    public static partial void PremiumAccountRequired(this ILogger logger, string retriever, [CallerMemberName] string caller = "");
